...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('tb_admin', function (Blueprint $table) {
            ...
            $table->foreign('pt_id')->references('id')->on('tb_pt')->nullable();
            ...
            $table->integer('status_satu')->default(1);
            $table->integer('status_dua')->default(0);
            $table->integer('status_tiga')->default(0);
            $table->timestamps();
        });
    }
