                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-lg-3">
                            <div class="mb-3 shadow-sm ">
                                <input type="text" class="form-control card-hover" placeholder="nama project atau no up"
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>
                                        ...
                                        @elseif($a->prioritas == 1)
                                        <span class="badge badge-warning">Warning</span>
                                        @elseif($a->prioritas == 2)
                                    ...
                                    <td>
                                        <div class="progress">
                                            <div class="progress-bar   @if($a->percentage == 100) bg-success @else progress-bar-striped progress-bar-animated @endif"
                                                role="progressbar" style="width: {{$a->percentage}}%"
                                                aria-valuenow="{{$a->percentage}}" aria-valuemin="0"
                                                aria-valuemax="100">
                                                @if($a->percentage == 100) complate! @else
                                                {{$a->percentage}}% @endif
                                            </div>
                                        </div>
                                    </td>
                                    <td class="text-center">
                                        <button wire:ignore.self type="submit" wire:click='lihatStepSatu({{$a->id}})'
                                            class="btn btn-secondary btn-circle btn-sm" data-toggle="tooltip"
                                            data-placement="left" title='Lihat Detail'>
                                            <i class="fas fa-eye"></i>
                                        </button>
                                        <button wire:ignore.self type="submit" wire:click='ubahStepSatu({{$a->id}})'
                                            class="btn btn-primary btn-circle btn-sm" data-toggle="tooltip"
                                            data-placement="left" title='Ubah Data'>
                                            <i class="fas fa-edit"></i>
                                        </button>
                                    </td>
                                    <td class="text-center">
                                        @if($a->status_dua > 0)
                                        <button wire:ignore.self type="button" wire:click='lihatStepDua({{$a->id}})'
                                            class="btn btn-secondary btn-circle btn-sm" data-toggle="tooltip"
                                            data-placement="left" title='Lihat Detail'>
                                            <i class="fas fa-eye"></i>
                                        </button>
                                        <button wire:ignore.self type="submit" wire:click='ubahStepDua({{$a->id}})'
                                            class="btn btn-primary btn-circle btn-sm" data-toggle="tooltip"
                                            data-placement="left" title='Ubah Data'>
                                            <i class="fas fa-edit"></i>
                                        </button>
                                    ...
                                    <td class="text-center">
                                        @if($a->status_tiga > 0)
                                        <button wire:ignore.self type="button" wire:click='lihatStepTiga({{$a->id}})'
                                            class="btn btn-secondary btn-circle btn-sm" data-toggle="tooltip"
                                            data-placement="left" title='Lihat Detail'>
                                            <i class="fas fa-eye"></i>
                                        </button>
                                        <button wire:ignore.self type="submit" wire:click='ubahStepTiga({{$a->id}})'
                                            class="btn btn-primary btn-circle btn-sm" data-toggle="tooltip"
                                            data-placement="left" title='Ubah Data'>
                                            <i class="fas fa-edit"></i>
                                        </button>
                                    ...
                                    <td class="text-center">
                                        <button wire:ignore.self type="button" wire:click='viewDetail({{ $a->id }})'
                                            class="btn btn-secondary btn-circle btn-sm" data-toggle="tooltip"
                                            data-placement="left" title='Lihat Detail Data'>
                                            <i class="fas fa-eye"></i>
                                        </button>
                                        <button wire:ignore.self type="button"
                                            wire:click='claimGaransiProject({{$a->id}})'
                                            class="btn btn-dark btn-circle btn-sm" data-toggle="tooltip"
                                            data-placement="left" title='Claim Garansi'>
                                            <i class="fas fa-shield-virus"></i>
                                        </button>
                                        <button wire:ignore.self type="button" wire:click='hapusProject({{$a->id}})'
                                            class="btn btn-danger btn-circle btn-sm" data-toggle="tooltip"
                                            data-placement="left" title='Hapus Data'>
